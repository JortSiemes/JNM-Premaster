...
[[Propositie]]: uitspraak (bv. een oordeel: “Amsterdam is de schoonste stad van Europa”, aanbeveling: “op rode wijnvlekken moet je meteen zout gooien”, of voorspelling: “een goede beheersing van het Engels zal bij sollicitaties een steeds belangrijker eis worden”) 
...
[[terugwijzende presentatie]]: want en immers
volgorde is [[standpunt]] > argumentatie

[[vooruitwijzende presentatie]]: dus, vandaar en daarom
volgorde is argumentatie > [[standpunt]]

verklaring, uitleg of toelichting
hebben een bijna zelfde structuur als argumentatie betoog echter omdat het de 'omdat'-uitspraak bevat moet dit niet hiermee worden verward.

[[maximaal argumentatieve interpretatie]] = uitspraken die ook mededelingen of uitleg of iets dergelijks zouden kunnen worden geinterpreteerd worden als argumentatie geinterpreteerd
...
# [[Week 8]]:
Samenvatting hoofdstuk 3 De retoriek van de ordening
...
# [[Vakken/Blok 2/Argumenteren en overtuigen/Week 12|Week 12]]:
argumentatietheorie
...
- [[Pathetische drogreden]]
	→ Beroep op allerlei emoties (niet enkel medelijden) 
	→ Emoties van derde partij worden aangevoerd als ondersteuni[[pathos|ng (pa]]thos vervangt [[logos]]) 
	→ Overtreding relevantieregel: emoties van publiek zijn meestal geen relevante ondersteuning 
- [[Argumentum ad baculum]] (drogreden van de stok) 
	→ Dreigement 
	→ Overtreding van de vrijheidsregel 

...
Data scraping: het automatisch verzamelen van grote hoeveelheden data van websites en databases
...
→  Je kunt je natuurlijk afvragen in hoeverre dit instagram-account echt telt als journalistiek platform, maar het is we een nieuwe en creatieve benadering van data en illustreert het eerdergenoemde citaat van hoe datajournalistiek traditionele journalistiek kan aanvullen en versterken.
...
- Democratisering: OSINT is niet langer exclusief voor inlichtingendiensten; journalisten, onderzoekers, activisten en zelfs burgers kunnen het toepassen (Belghith et al., 2022). Organisaties als Bellingcat hebben de journalistieke toepassing gepopulariseerd.
...
- Misinformatie & Desinformatie: Open bronnen kunnen onjuist, misleidend of gemanipuleerd zijn (bijv. oude beelden hergebruikt in een nieuwe context zoals bij de Oekraïne-invasie; AI-gegenereerde deepfakes zoals de Pelosi-video). Rigoureuze verificatie is cruciaal.
...
- Efficiëntie: Het kan helpen om snel informatie te vinden en te verifiëren.
...
1.    Allereerst is de uitdaging om het imago van NRS te verbeteren.
...
-            Onware, inaccurate of misleidende informatie.

-            Met opzet gemaakt en verspreid.

-            Om een persoon, sociale groep, organisatie of land te schaden.

-            Of om geld mee te verdienen.
...
-            Bijv. Wanneer iemand een misleidend bericht doorstuurt terwijl diegene zelf niet doorhad dat het misinformatie was.

Nepnieuws:

-            Verzonnen berichten die de vorm hebben van een nieuwsbericht, maar die niet geschreven of gecontroleerd zijn door een professionele journalist.

-            Term wordt ook gebruikt als synoniem voor leugens of onzorgvuldige journalistiek.

Bron: Rijksoverheid.nl

![Afbeelding met tekst, schermopname, Lettertype, nummer
Door AI gegenereerde inhoud is mogelijk onjuist.](https://lh7-rt.googleusercontent.com/docsz/AD_4nXejYZA587ui6hEmh65hCJHDPrsclH-oVKL1FQOZyJZOSKPI24xrVgj-4Ymc8A74w_dvIqOTjUfAfhmtYod97BOkx3lY8wLFW9ZsbsLRBo3nJhPnxz_YZkoPP5G4oMhJC6SdgFAJ?key=i5UfwhUNs8nOxG_GSP6pfAgA)

Misinformaite is een schaal. Ook gaat het twee kanten op. (Bijv. zowel het ontkennen van de schadelijkheid van vapes, als het overdrijven van de schadelijkheid van vapes, is een vorm van misinformatie. Dit komt beide evenveel voor.) Nieuwsmedia worden het vaakst beschuldigd van misinformatie. Maar beschuldigingen van misinformatie zijn tegenwoordig heel vaak politiek gemotiveerd en duiden op een meningsverschil.

Wat doe je als journalist tegen misinformatie:

1.       Zorg dat je artikel klopt

a.       Meeste misinformatie door een verkeerde interpretatie van bijv. wetenschap.

2.       Corrigeren met gedetailleerde informatie, niet alleen een sticker ‘fake news’. Dan kunnen mensen zich later niet herinneren wat er niet klopte. (Sally Chan et al. 2017)

3.       Snel corrigeren, aansluiten op het wereldbeeld van je publiek, correctie vanuit dezelfde bron als de misinformatie zelf werkt het beste. (Walter et al. 2020)

Waarom werken interventies tegen misinformatie slecht:

1.       Ook na correctie is er een klein maar significant effect van de misinformatie. (Walter et al. 2020)

2.       Het is in het algemeen bewezen dat het moeilijk is om met communicatie-interventies, iemands intentie en gedrag te beïnvloeden. Dat geeft altijd maar een klein effect. (Hoeken 2019)

Angst rondom misinformatie wordt ook overdreven gevonden:

Uit onderzoek (Budak et a. 2024) blijkt dat mensen in praktijk maar weinig worden blootgesteld aan misinformatie in hun online nieuwsconsumptie. De rol van algoritmes in het verspreiden van misinformatie wordt overdreven. Het zijn vaak kleine groepen die zelf actief op zoek zijn naar die misinformatie, en die er dus toch al in geloven, die het gemiddelde omhoogtrekken.

De gevaarlijkste bronnen van misinformatie zijn politici en journalisten, dan heeft het de grootste impact. (slide 24 presentatie social media)

Slide 32-38

Schandaal: Cambridge Analytica

Wie:

-            Cambridge Analytica, databedrijf

o   Combineert het veramelen en analyseren van data met gerichte marketing en strategische communicatie voor verkiezingscampagnes.

-            Facebook

o   Sociale medium via waar miljoenen gegevens zijn “buitgemaakt.”

-            Steve Bannon

o   Toenmalig leider van Cambridge Analytica, later belangrijke rol in campagne Donald Trump.

-            Christopher Wylie

o   Klokkenluider, werkte tot eind 2014 bij Cambridge Analytica.

Tijdlijn:

2014

-            Cambridge Analytica krijgt de persoonlijke gegevens van 270 duizend Facebookgebruikers, vooral Amerikanen, in handen. Zij vulden via een door Cambridge Analytica ontwikkelde app een persoonlijkheidstest in waarbij hun gegevens zouden mogen worden gebruikt voor wetenschappelijk onderzoek.

-            Via de test-invullers kreeg het bedrijf ook alle Facebook-gegevens van hun vrienden in handen. Hiermee verzamelde ze gegevens van ca. 87 miljoen profielen.

Eind-2015

-            Facebook ontdekt dat er op grote schaal informatie is verzameld. Zij doen weinig met deze informatie, maken het niet bekend aan hun gebruikers en zetten slechts minimale stappen om te verzekeren dat de verzamelde informatie is verwijderd.

2016

-            De verzamelde gegevens van 50 miljoen Amerikanen, ⅓ van de stemgerechtigden, zouden zijn gebruikt om profielen op te stellen om op basis hiervan met gepersonaliseerde politieke advertenties de campagne van Trump te bevorderen.

17 maart 2018:

-            Onthulling van het data-leik in The New York Times en The Observer, op basis van informatie via klokkenluider Christopher Wylie.

-            Facebook dreigde met een rechtszaak om de publicatie van dit verhaal tegen te houden.

-            Cambridge Analytica verklaart alle gegevens verwijderd te hebben en deze nooit gebruikt te hebben voor de Amerikaanse verkiezingen.

-            Maar tegelijkertijd zijn er duidelijke banden tussen Cambridge Analytica en de Republikeinse partij. O.a. via Steve Bannon.

Tijdens de onthullingen in de krant, komen er via Channel 4 ook stiekem opgenomen beelden naar buiten waarin de leiding van het bedrijf zegt dat ze bereid zijn propaganda te verspreiden, mensen af te persen en politici in de val te lokken met mooie vrouwen. Cambridge Analytica is ook bekend doordat ze gewerkt hebben voor het leave-kamp van brexit.

Conclusie:

- Cambridge Analytica stelt dat zij altijd legaal en ethisch hebben gewerkt en dan hun aanpak een normale manier is van online adverteren, ook in de politieke sector (NOS, 3 mei 2018).
    
- Na alle ophef hebben zij veel klanten verloren en vrezen ze voor rechtszaken en boetes (NOS, 3 mei 2018).
    
- Cambridge Analytica vraagt faillisement aan en “stopt.”
    
- Tegelijkertijd begint het bedrijf Emerdata met veel van dezelfde sleutelfiguren en op hetzelfde adres. Zo zit de voormalig CEO van Cambridge Analytica in de raad van bestuur van Emerdata (De Tijd, 3 mei 2018).
    

Platform beat: (Napoli, P. 2021)

Journalisten die aan ‘platform beat’ doen, publiceren over hoe platforms en zoekmachines werken, en hoe ze gebruikt en misbruikt worden.

Dit is een nieuwe vorm van waakhond-journalistiek waarbij digitale platforms verantwoordelijk gehouden worden.

Twee onderdelen:

-            Het in de gaten houden hoe de platforms werken, hoe ze omgaan met geberuikersdata, hoe hun advertentiesystemen en algoritmes werken etc.

-            Het in de gaten houden welke content er op de platforms verspreid wordt. Bijvoorbeeld letten op haat, oproepen tot geweld en nepnieuws.

Maar er zit een zekere spanning in de dynamiek tussen platforms en de journalisten die platforms controleren en verantwoordelijk houden. Platforms hebben een centrale rol in het nieuws-ecosysteem. Journalisten houden zo een instantie in de gaten, die tegelijkertijd één van de belangrijkste verspreiders is van journalistiek.

4 factoren die de waakhondfunctie kunnen ondermijnen m.b.t. platforms:

- Economic interdependence
    

- Denk: ze zijn van elkaar afhankelijk.
    

- Competition
    

- Denk: ze zijn ook elkaars concurrenten voor het trekken van bezoekers op hun website en voor het zijn van een bron van nieuws.
    

- Technological complexity opacity
    

- Denk: het is niet altijd even duidelijk hoe die platforms precies werken. Het kan verschillen hoe open ze zijn naar journalisten en onderzoekers.
